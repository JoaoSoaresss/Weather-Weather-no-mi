    ...
    <div class="offcanvas offcanvas-start bg-white border-end min-vh-100" tabindex="-1" id="sidebar">
      ...
      <div class="offcanvas-body p-3">
        <div class="nav flex-column gap-2">
          <a href="comparar.php" class="nav-link sidebar-item">
    ...
    <div class="container mt-4">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card shadow-sm mb-4">
            <div class="card-body">
              <h4 class="fw-bold mb-3">Weather Details</h4>
              <div class="row g-3">
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <i class="bi bi-moisture fs-4 me-2 text-primary"></i>
                    <div>
                ...
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <i class="bi bi-wind fs-4 me-2 text-primary"></i>
                    <div>
                ...
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <i class="bi bi-thermometer-half fs-4 me-2 text-primary"></i>
                    <div>
                ...
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <i class="bi bi-sunrise fs-4 me-2 text-primary"></i>
                    <div>
                ...
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <i class="bi bi-sunset fs-4 me-2 text-primary"></i>
                    <div>
      ...
      <div class="row mb-4">
        ...
        <div class="col-lg-6 mb-3">
          <div class="card shadow-sm">
            <div class="card-body">
              <h4 class="fw-bold mb-3">Daily Extremes</h4>
              <p>Max: <span id="daily-max">--</span></p>
              <p>Min: <span id="daily-min">--</span></p>
            </div>
          </div>
        </div>
        <!-- Historical Extremes -->
        <div class="col-lg-6 mb-3">
          <div class="card shadow-sm">
            <div class="card-body">
              <h4 class="fw-bold mb-3">Historical Extremes (2000–2025)</h4>
              <p id="historical-loading" class="text-muted">Fetching historical data...</p>
              <div id="yearly-max-section" class="d-none">
                <p id="yearly-max-label">Historical Max</p>
                <p>Max: <span id="yearly-max">--</span></p>
              </div>
              <div id="yearly-min-section" class="d-none">
                <p id="yearly-min-label">Historical Min</p>
                <p>Min: <span id="yearly-min">--</span></p>
              </div>
            </div>
          </div>
        </div>
